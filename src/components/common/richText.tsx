...
const LongText = ({ longText, truncate = false }: { longText: string; truncate?: boolean }) => {
    ...
    return <div dangerouslySetInnerHTML={{ __html: sanitizedText }} className="text-gray-400"></div>;
};
