...
import {
  addBookFormSchemaResolver,
  TAddBookFormType,
} from "@/components/common/addBookModal/addBookModal.helper";
    ...
    <Dialog>
      ...
      <DialogContent className="bg-gray-900 text-white sm:max-w-[425px] overflow-y-auto h-[70vh] mr-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full bg-white text-purple-500 hover:bg-purple-500 hover:text-white"
          >
        ...
        <DialogFooter>
          <DialogClose asChild>
            <Button
              type="submit"
              className="my-2 hover:bg-white hover:text-black duration-300 w-full"
            >
              Cancel changes
            </Button>
          </DialogClose>
